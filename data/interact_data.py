...
def insert_user_interaction(connection, place_id, rating, rating_count, is_open, drive_time, accepted, user_id):
    query = '''
...
def delete_user_interactions(connection, user_id):
...
#Fetching data
def fetch_user_interaction(connection, id, user_id):
...
def fetch_user_interactions(connection, user_id):
